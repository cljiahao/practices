...
<div align="center">
  <strong>Coding similar types of Calculator using different programming languages</strong>
</div>
<div align="center">
  Completed languages: Python (Tkinter), HTML5
</div>
...
Roadmap to being a full-stack developer, tasked myself to program out similar calculators using differnt programming langugages.

This repo serves as a history of my achievements as well as portfolio for future references.
...
3. Clone Repo
   ...
   ```
4. Close command line and start coding!!! :computer:
...
- [ ] To include testing folder for each calculator
